    ...
    <script>
        ...
        (function() {
            ...
            function detectDevice() {
                ...
                // iPad Detection
                else if (/ipad/.test(userAgent) || (navigator.platform === 'MacIntel' && isTouch)) {
                ...
                else if (isTouch && window.innerWidth <= 768) {
                    deviceInfo.type = 'mobile';
                }
            ...
            function detectConnection() {
                if ('connection' in navigator) {
                    ...
                    deviceInfo.connection = connection.effectiveType || 'unknown';
                }
            }
            ...
            function applyOptimizations() {
                ...
                body.classList.remove('device-mobile', 'device-iphone', 'device-ipad', 'device-tablet', 'device-desktop');
            ...
            function optimizeForViewport() {
                ...
                if (viewport.width >= 1920) {
                    ...
                    const style = document.createElement('style');
                    style.textContent = \`
                        .viewport-large .service-card:hover {
                            transform: translateY(-12px) scale(1.02);
                        }
                    \`;
                    document.head.appendChild(style);
                    ...
                    const observer = new PerformanceObserver((list) => {
                        ...
                        entries.forEach((entry) => {
                            if (entry.entryType === 'paint' && entry.name === 'first-contentful-paint') {
                                // If FCP is slow, reduce animations
                                if (entry.startTime > 2000) {
                                    document.body.classList.add('performance-limited');
                                    const style = document.createElement('style');
                                    style.textContent = \`
                                        .performance-limited * {
                                            animation-duration: 0.1s !important;
            ...
            function setupLazyLoading() {
                if (deviceInfo.type === 'mobile' || deviceInfo.type === 'iphone') {
            ...
            function setupTouchOptimizations() {
                if (deviceInfo.isTouch) {
                    ...
                    style.textContent = \`
                        ...
                        .device-touch .service-card:active {
                            transform: scale(0.98);
                            transition: transform 0.1s ease;
                        }

                        .device-touch .treatment-item:active {
                    ...
                    if (deviceInfo.type === 'iphone' || deviceInfo.type === 'ipad') {
            ...
            function init() {
                ...
                // Update optimizations on resize
